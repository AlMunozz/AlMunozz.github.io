...
const sendEmail = (e) =>{
  ...
  if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
      ...
      //Show message
      contactMessage.textContent = 'fill out the entire form 📑'
  } else{
      //ServiceID - templateID - #form - publicKey
      emailjs.sendForm('service_zvyq71g', 'template_k4pcu8l', '#contact-form', 'tz_OFGyM5xYZQeimQ')
        .then(() =>{
            ...
            alert('OOPS! Something has failed... Try again please!', error)
        })
